...
4 - Differentiating setup scripts run at first load of bundle and runAgain on load
...
const pageReset = (mutList, observer)=>{
    // markup additions
...
if (typeof window.THISCO_INSTALLED == "undefined") {
    pageSetup();
    pageReset();
    window.THISCO_INSTALLED = true;
